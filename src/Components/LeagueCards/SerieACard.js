...
const LeagueCards = ({ datas }) => {
  ...
  return (
    <>
      <section
        className=" bg-seria-logo bg-cover bg-no-repeat bg-center h-32 w-2/5 opacity-80 transition-all duration-1000 ease-in-out hover:opacity-100 cursor-pointer rounded-br-2xl rounded-tl-2xl transform -translate-x-40 m-5 hover:-translate-x-32 hover:scale-105 hover:border-green-700 border-2 border-solid "
