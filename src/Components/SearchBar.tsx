...
import { Team } from '../Requests/Intefaces/interfaces-requests';
...
const SearchBar = () => {
   ...
   const provideAlert = (message: string, success: string | null) => {
   ...
   const checkAndAdd = (playerName: string) => {
      const { equipe } = data as Team;
      let result = true;
               ...
               >
                  {playerFetched ? (
                     ...
                     alert.message && (
                        ...
                        >
                           <p className=' h-full md:h-11 font-normal '>
                              {alert.message}
                           </p>
                        </div>
                     )
